...
# %%
#Fonctions splits
def split_OneTrip(trip, st = 0.5, k1 = 0.1, k2 = 0.1, random = 1):
	'''
...
dv.affiche_carte(df, pos, latitude_min, latitude_max, longitude_min, longitude_max, ecart_x, ecart_y)
...
sns.heatmap(mat_err, linewidths=.5, cmap="YlGnBu", yticklabels = np.arange(n_interval-1,-1,-1))
plt.show()
